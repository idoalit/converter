<?php
namespace Slims\Persneling\Item\Models;
...
#  }
  ...
  public function createItem($dbs, $item)
  {
    ...
    if (!$is_exist) {
      ...
      $s_sitem = 'INSERT INTO item (item_code) VALUES (\''.$item['item_code'].'\')';
  ...
  public function fgetItemIdByItemcode($dbs, $item=array())
  {
    if (!empty($item['item_code'])) {
      ...
      return $this->createItem($dbs, $item);
      } else {
        #die($res['author_id']);
        #echo($res['author_id']);
        #die('<hr />tesdah');
